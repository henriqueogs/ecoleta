                ...
                <View style = {styles.mapContainer}>
                   {initialPosition[0] !== 0 && (
                      <MapView 
                        style = {styles.map} 
                        initialRegion={{
                            latitude: initialPosition[0], //-21.0278253,
                            longitude: initialPosition[1], //-44.3248135,
                            latitudeDelta: 0.014,
                      ...
                      {points.map(point =>(
                        <Marker 
                          ...
                          coordinate={{
                              latitude: point.latitude,   //-21.0278253,
                              longitude: point.longitude //-44.3248135,
                          }}
                        >
                    ...
                    >
                      {itens.map(item => (
                        <TouchableOpacity 
                          ...
                          onPress={() => handleSelectIten(item.id)}
                          activeOpacity={0.6}
                        > 
